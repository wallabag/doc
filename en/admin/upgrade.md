...
1. Please check that your `app/config/parameters.yml` contains all the parameters as they are **all mandatory**. You can find documentation about parameters [here](./parameters.md).
...
1. If you use SQLite, you must copy your `data/` folder into the new installation.
...
1. You may encounter issues with index names: if so, please change the queries to use the correct index name.
1. You can find all the required queries in the [query upgrade documentation](./query-upgrade-22-23.html).
